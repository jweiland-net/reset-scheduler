...
namespace JWeiland\ResetScheduler\Domain\Repository;

use Doctrine\DBAL\Exception as DBALException;
use JWeiland\ResetScheduler\Exception\InvalidTaskException;
use JWeiland\ResetScheduler\Service\TaskService;
use JWeiland\ResetScheduler\Task\TaskSerializer;
use JWeiland\ResetScheduler\Validation\Validator\TaskValidator;
...
class SchedulerTaskRepository
{
     ...
     */
    public function remove($task): bool
    {
     ...
     */
    public function removeExecutionOfTask(AbstractTask $task, int $executionID, $failureReason = null): void
    {
        $row = $this->findRecordByUid($task->getTaskUid());
